<#
# Install Windows ADK 1809, Windows PE Addon and WDS 
#
# This script:            Downloads and installs Windows ADK 1809, then downloads the Windows ADK Window PE Addon. Next, installs WDS for Microsoft MDT
# Before running:         Modify the ADK download path source variable (line 28), if you have already downloaded the ADK manually copy the content of "Windows Kits" to the source folder
...
# Variable (where to download the content)
$SourcePath = "C:\Source"
...
# Download Windows Assessment and Deployment Kit (ADK 10 version 1809)
...
Write-Host "Downloading Windows ADK 10 which is approx 1.14GB in size, please wait..."  -nonewline
...
# Download the ADK 10 version 1809 Windows PE Addon
...
Write-Host "Downloading the Windows PE addon for Windows ADK 10 which is approx 2.81GB in size, please wait..."  -nonewline
...
Write-Host "Installing Windows ADK 10 version 1809..."
